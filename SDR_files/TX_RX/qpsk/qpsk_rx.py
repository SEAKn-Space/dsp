...
class qpsk_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "qpsk_rx", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("qpsk_rx")
        ...
        self.baseband_LO = baseband_LO = 20_200
        self.MTU = MTU = 1500
        ...
        self._baseband_LO_range = Range(0, 50_000, 100, 20_200, 200)
        ...
        self.analog_feedforward_agc_cc_0_0 = analog.feedforward_agc_cc(1024, 1.55)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_feedforward_agc_cc_0, 0), (self.low_pass_filter_0_0, 0))
        self.connect((self.analog_feedforward_agc_cc_0_0, 0), (self.digital_symbol_sync_xx_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, 6e3, 1.6E3, window.WIN_HAMMING, 6.76))
