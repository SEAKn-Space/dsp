...
import osmosdr
import time
import qpsk_txrx_updated_EPB as updated_EPB  # embedded python block
import sip
...
class qpsk_txrx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.updated_EPB = updated_EPB.blk(FileName="../../test_io/test.png", Pkt_len=packet_len, initial_packet_fill=30)
        self.updated_EPB.set_min_output_buffer((2**16))
        ...
        self.soapy_hackrf_sink_0_0.set_sample_rate(0, 20*samp_rate)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_c((rtl_samp_rate/10), analog.GR_COS_WAVE, (-12_000), 0.5, 0, 0)
        ...
        self.connect((self.rational_resampler_xxx_0, 0), (self.soapy_hackrf_sink_0_0, 0))
        ...
        self.connect((self.updated_EPB, 0), (self.digital_crc32_bb_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.soapy_hackrf_sink_0_0.set_sample_rate(0, 20*self.samp_rate)
    ...
    def set_packet_len(self, packet_len):
        ...
        self.updated_EPB.Pkt_len = self.packet_len
