...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 44_100*45
        self.carrier_freq = carrier_freq = 435e6
        self.audio_rate = audio_rate = 44_100
        ...
        self.connect((self.analog_wfm_rcv_pll_0, 1), (self.blocks_multiply_const_vxx_0_0, 0))
        self.connect((self.analog_wfm_rcv_pll_0, 1), (self.qtgui_freq_sink_x_0, 1))
        self.connect((self.analog_wfm_rcv_pll_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.analog_wfm_tx_0, 0), (self.analog_wfm_rcv_pll_0, 0))
