...
import eight_psk_tx_epy_block_0 as epy_block_0  # embedded python block
import sip



class eight_psk_tx(gr.top_block, Qt.QWidget):

    def __init__(self, InFile='default'):
        gr.top_block.__init__(self, "8psk_tx", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("8psk_tx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "eight_psk_tx")
        ...
        self.epy_block_0 = epy_block_0.blk(FileName="../../test_io/test.png", Pkt_len=60)
...
def main(top_block_cls=eight_psk_tx, options=None):
    if options is None:
