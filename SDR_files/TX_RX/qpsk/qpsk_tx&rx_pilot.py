...
class qpsk_tx&rx_pilot(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "qpsk_tx&rx_pilot")
        ...
        self.analog_sig_source_x_0_1 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, 7_500, 0.7, 0, 0)
...
def main(top_block_cls=qpsk_tx&rx_pilot, options=None):
