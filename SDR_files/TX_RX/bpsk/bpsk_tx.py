...
class bpsk_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, InFile='default'):
        ...
        self.transmit_freq = transmit_freq = 435.15e6
        self.sps = sps = 4
        ...
        self.soapy_hackrf_sink_0.set_sample_rate(0, usrp_rate)
        ...
        self.connect((self.blocks_throttle2_0_0, 0), (self.soapy_hackrf_sink_0, 0))
    ...
    def set_usrp_rate(self, usrp_rate):
        ...
        self.mmse_resampler_xx_0.set_resamp_ratio((1.0/((self.usrp_rate/self.samp_rate)*self.rs_ratio)))
        self.soapy_hackrf_sink_0.set_sample_rate(0, self.usrp_rate)
