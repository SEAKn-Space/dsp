...
# Title: qpsk receive and file read
# Author: SEAKn Space
# Description: Demodulate QPSK signal from IQ file
...
class qpsk_rx_fileRead(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "qpsk receive and file read", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("qpsk receive and file read")
        ...
        self.settings = Qt.QSettings("GNU Radio", "qpsk_rx_fileRead")
        ...
        self.zeromq_pull_source_0 = zeromq.pull_source(gr.sizeof_gr_complex, 1, 'tcp://127.0.0.1:5000', 100, False, (-1), False)
...
def main(top_block_cls=qpsk_rx_fileRead, options=None):
