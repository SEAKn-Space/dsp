...
class eight_psk_rx(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "8psk_rx", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("8psk_rx")
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 12_000, 1_600, window.WIN_HAMMING, 6.76))
